...
void AAuraPlayerController::ShowDamageNumber_Implementation(const float Damage, ACharacter* TargetCharacter, bool bBlockedHit, bool bCriticalHit)
{
...
void AAuraPlayerController::SetupInputComponent()
{
	...
	AuraInputComponent->BindAction(MoveAction, ETriggerEvent::Completed, this, &AAuraPlayerController::Move);
...
void AAuraPlayerController::Move(const FInputActionValue& InputActionValue)
{
	...
	bIsMoving = InputAxisVector.Size() > 0.f;
